function guardarFaq() {
    ...
    if (model.idFaq != 0 && model.posicion != null) {
        $.ajax({
            url: "/Operaciones/Faq/ComprobarPosicion",
            type: "get",
            cache: false,
            data: { idFaq: model.idFaq, posicion: model.posicion },
        }).done((result) => {
            if (result) {
                Swal.fire({
...
$('#FaqVM_Posicion').keypress(function (e) {
